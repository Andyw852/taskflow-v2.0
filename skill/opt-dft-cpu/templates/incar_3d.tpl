...
#   opt-dft-cpu 调度写死在 gen_step1_opt.py：先固定胞安顿原子、再放开胞，力判据 -0.05，EARLY_EXIT 关
#     阶段 a  ISIF=2 IBRION=2(CG)  EDIFFG=-0.05  NSW=80   （固定胞）
#     阶段 b  ISIF=3 IBRION=2(CG)  EDIFFG=-0.05  NSW=120  （放开胞，从 a 的 CONTCAR 接力）
